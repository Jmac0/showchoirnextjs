...
export function Hero({
  ...
  return (
    <section className="flex flex-col overflow-hidden bg-black">
      ...
      {/* hero text block */}
      <Logo color="gold" />
      <main className="z-1 flex flex-col items-center md:px-10 lg:flex-row xl:px-12">
        <section className="text-md mb-8 flex w-full min-w-0 flex-col rounded-md border-2 border-lightGold bg-gradient-to-br from-lightBlack/75 to-black/75 p-5 px-3 pt-1 md:mr-5 xl:w-2/3">
          {heroTextGreeting}
